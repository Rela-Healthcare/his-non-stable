...
import {depositInformation,addToDeposit, resetDepositInformation,} from "../../../features/OPDModule/DepositAllocation/DepositSlice";
 ...
 // console.log(loginData);
  ...
  const fetchData = async () => {
    if (search !== "") {
      ...
      console.log(fetchResponse);
      // setExisitingPatientsData(fetchResponse);
  ...
  const payload = {
    ...
    RefundAmount:depositData.amountTobeAdded,
    Reason: depositData.depositRemarks,
    UserId: userName,
    PayeeName:depositData.patientName,
    PayeeICNo: ""
  };

  const saveDepositData = async () => {
    const depositSaveResponse = (await OPModuleAgent.SaveRefund(payload))
      .data;
